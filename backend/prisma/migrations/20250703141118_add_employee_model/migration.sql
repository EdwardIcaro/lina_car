...
INSERT INTO "new_WorkOrder" ("createdAt", "finishedAt", "id", "status", "totalPrice", "vehicleId") SELECT "createdAt", "finishedAt", "id", "status", "totalPrice", "vehicleId" FROM "WorkOrder";
